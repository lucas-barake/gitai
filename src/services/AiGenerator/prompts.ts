...
const TITLE_PROMPT_SECTION = `- Write a clear, concise title that summarizes the most impactful change.
  - Use imperative mood (e.g., "Add", "Fix", "Update", not "Added", "Fixed", "Updated").
  - Keep it under 72 characters.
  - Focus on what the change *does* for the user or the system.
  - Avoid generic verbs like "update" or "improve" when a more specific verb is available.`;
